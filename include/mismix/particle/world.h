#ifndef __ps_mmm__particle_world_h
#define __ps_mmm__particle_world_h
    ...
    class World
    {
      private:
                                     ...
                                     const LevelInd cur_cell)
        {
          ...
          found_cell = typename parallel::distributed::Triangulation<dim>::cell_iterator
                       (triangulation, cur_cell.first, cur_cell.second);
      ...
      public:
         ...
         * world.
         *
         * @param [in] new_solution The new TrilinosWrappers::MPI::Vector
         * solution for this world.
         */
        void set_solution(const TrilinosWrappers::MPI::Vector *new_solution)
        {
         ...
         */
        void advance_timestep(const double timestep, const TrilinosWrappers::MPI::Vector &solution)
        {
         ...
         * simulation.
         */
        void get_particle_velocities(const TrilinosWrappers::MPI::Vector &solution)
        {
          ...
          Functions::FEFieldFunction<dim, DoFHandler<dim>, TrilinosWrappers::MPI::Vector> fe_value(*dof_handler, solution, *mapping);
