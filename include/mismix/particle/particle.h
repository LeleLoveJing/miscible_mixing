#ifndef __ps_mmm__particle_particle_h
#define __ps_mmm__particle_particle_h

//#include <mismix/postprocess/interface.h>
//#include <mismix/simulator_access.h>
  ...
  namespace Particle
  {
    ...
    class BaseParticle
    {
      ...
      public:
         ...
         * ID at the specified location with zero velocity. Note that ps_mmm
