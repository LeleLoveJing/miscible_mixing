\hypertarget{class_equation_data_1_1_inflow___velocity}{}\section{Equation\+Data\+:\+:Inflow\+\_\+\+Velocity$<$ dim $>$ Class Template Reference}
...
\subsubsection[{Inflow\+\_\+\+Velocity(double, unsigned int)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$int dim$>$ {\bf Equation\+Data\+::\+Inflow\+\_\+\+Velocity}$<$ dim $>$\+::{\bf Inflow\+\_\+\+Velocity} (
...
\subsubsection[{value(const Point$<$ dim $>$ \&p, const unsigned int component=0) const }]{\setlength{\rightskip}{0pt plus 5cm}template$<$int dim$>$ double {\bf Equation\+Data\+::\+Inflow\+\_\+\+Velocity}$<$ dim $>$\+::value (
\begin{DoxyParamCaption}
...
\subsubsection[{vector\+\_\+value(const Point$<$ dim $>$ \&p, Vector$<$ double $>$ \&value) const }]{\setlength{\rightskip}{0pt plus 5cm}template$<$int dim$>$ void {\bf Equation\+Data\+::\+Inflow\+\_\+\+Velocity}$<$ dim $>$\+::vector\+\_\+value (
\begin{DoxyParamCaption}
\item[{const Point$<$ dim $>$ \&}]{p, }
...
\subsubsection[{vector\+\_\+value\+\_\+list(const std\+::vector$<$ Point$<$ dim $>$ $>$ \&p, std\+::vector$<$ Vector$<$ double $>$ $>$ \&values) const }]{\setlength{\rightskip}{0pt plus 5cm}template$<$int dim$>$ void {\bf Equation\+Data\+::\+Inflow\+\_\+\+Velocity}$<$ dim $>$\+::vector\+\_\+value\+\_\+list (
\begin{DoxyParamCaption}
...
\subsubsection[{init\+\_\+mean\+\_\+vel}]{\setlength{\rightskip}{0pt plus 5cm}template$<$int dim$>$ double {\bf Equation\+Data\+::\+Inflow\+\_\+\+Velocity}$<$ dim $>$\+::init\+\_\+mean\+\_\+vel}\label{class_equation_data_1_1_inflow___velocity_a00fdc2d87172dbf05e274529d53e4874}
